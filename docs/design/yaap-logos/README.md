...
Open index.html for the comparison, or the individual study HTML pages. These are historical design explorations. The current application assets are in [`apps/web/public/brand`](../../../apps/web/public/brand); use those for product documentation.
